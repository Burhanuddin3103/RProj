#' Send diagnostic email to rproj admin
#' 
...
email_admin <- function() {
  # Get session info and rproj package version
  si <- capture.output(sessionInfo())
  pv <- packageVersion('rproj')
  
  # Set up email elements address, subject, and body
  address <- 'info@rprojstats.com'
  subject <- paste('Need help: rproj', pv)
